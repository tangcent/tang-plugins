...
open class KotlinModule : AbstractModule() {
     ...
     * handler.
     */
    protected fun <A : Annotation> bindMethodHandler(annotationType: Class<A>,
    ...
    private fun <A : Annotation> bindMethodHandler(annotationType: Class<A>,
     ...
     */
    protected fun <T : Any> bind(type: KClass<T>,
                                 annotationType: Class<out Annotation>): LinkedBindingBuilder<T> {
