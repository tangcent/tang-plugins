...
object SwingUtils {
    ...
    fun scroll(jTextArea: JTextArea, row: Int = 0, column: Int = 0, rowSpan: Int = 1, colSpan: Int = 1, anchor: Int = GridConstraints.ANCHOR_CENTER,
               fill: Int = GridConstraints.FILL_BOTH, hSizePolicy: Int = GridConstraints.SIZEPOLICY_CAN_SHRINK or GridConstraints.SIZEPOLICY_CAN_GROW,
