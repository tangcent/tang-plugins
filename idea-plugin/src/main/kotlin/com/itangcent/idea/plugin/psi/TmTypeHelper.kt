...
class TmTypeHelper {
    ...
    private val classCanonicalTextCache: HashMap<String, PsiClass?>
            = HashMap()
    private val tmTypeCanonicalTextCache: HashMap<String, TmType?>
            = HashMap()
    ...
    private fun doResolve(typeCanonicalText: String, context: PsiElement): TmType? {
        ...
        when {
            ...
            typeCanonicalText.startsWith("? extends") -> return resolve(typeCanonicalText.removePrefix("? extends").trim(), context)
    ...
    private val classCache: HashMap<String, PsiClass?>
            = HashMap()
    ...
    fun extractClassFromCanonicalText(typeCanonicalText: String, context: PsiElement): PsiClass? {
        ...
        return classCanonicalTextCache.computeIfAbsent(classCanonicalText, { _ -> findClass(classCanonicalText, context) })
    }
