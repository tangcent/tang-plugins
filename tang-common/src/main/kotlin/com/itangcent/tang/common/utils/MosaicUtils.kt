...
object MosaicUtils {
    ...
    private val idCardMosaic = mosaicBuild().keep(5).mosaic(4, '*').skipTo(-5).appendTail().returnDefectOnError().build()
    ...
    class SafetyMosaicBuild : MosaicBuild {
        ...
        constructor(actions: MutableList<MosaicAction>, tail: Int, minLen: Int, exceptionHandle: MosaicExceptionHandle?) {
        ...
        internal fun safetyCopy(srcAndResult: Array<CharArray>, src: CharArray, srcPos: Int,
        ...
        override fun keep(len: Int): SafetyMosaicBuild {
            addAction(object : SafetyMosaicAction {
                override fun next(srcAndResult: Array<CharArray>, src: CharArray, result: CharArray, indexes: IntArray) {
    ...
    private class ActionsMosaic : Mosaic {
        ...
        constructor(actions: kotlin.Array<com.itangcent.tang.common.utils.MosaicUtils.MosaicAction>, minLen: kotlin.Int, exceptionHandle: MosaicExceptionHandle?) {
            this.actions = actions
            this.minLen = minLen
            this.exceptionHandle = exceptionHandle
        }
